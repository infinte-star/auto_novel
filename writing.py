...
# 展示而非告知（正向技法）+ 收尾技法。ANTI_PITFALL_BLOCK 是"禁什么"（负向）；本块是"怎么写好"
# （正向 + 对照范例），二者互补。研究显示 deepseek/Claude 类写手默认 tell>show、爱抽象——反应式
# 的 ai_flavor 门是兜底，写手侧正向 push 才治本。这是本会话"神级提示词"调研落地的最高杠杆一击。
