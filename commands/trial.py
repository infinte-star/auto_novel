...
from engine.llm import build_client, call_llm, json_prompt, load_json_with_repair
from engine.bootstrap import bootstrap, cacheable_prefix, memory_context
from engine.store import init_db
...
def run_opening_trial(variants: int | None = None, chapters: int | None = None) -> Path:
    ...
    try:
        from commands.benchmark import benchmark_context, platform_guidance
