# Compare: verify_framework vs verify_framework_optimized_p0_strict_final
Generated 2026-08-04T11:59:01

| metric | verify_framework | verify_framework_optimized_p0_strict_final |
|---|---|---|
| chapters scored | 5 | 5 |
| avg score | 0.00 | 0.00 |
| min score | 0.00 | 0.00 |
...
| LLM total minutes | 31.83 | 41.10 |
| planning share of LLM time | 0.00 | 0.00 |
| LLM minutes / scored chapter | 6.37 | 8.22 |

## Per-chapter scores and rework
| ch | verify_framework score | pen | rework | verify_framework_optimized_p0_strict_final score | pen | rework |
|---|---|---|---|---|---|---|
...
## Heuristic verdict
- cheaper per chapter: **verify_framework** (6m vs 8m)
